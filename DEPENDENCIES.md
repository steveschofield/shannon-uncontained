...
- **secretfinder** — `git clone https://github.com/m4ll0k/SecretFinder.git ~/.local/share/shannon-tools/secretfinder` then run `python3 -m pip install --user jsbeautifier requests-file` and `python3 ~/.local/share/shannon-tools/secretfinder/SecretFinder.py`
