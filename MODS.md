...
- `setup.sh` — Added Kali optional tool installation (apt/pipx).
- `README.md` — Documented Kali tool extensions.
- `README-Kali.md` — Updated Kali tool coverage list.
- `DEPENDENCIES.md` — Added Kali optional tool install guidance.

### Rationale
Increase endpoint and file discovery coverage on Kali without requiring Docker, while keeping all tools optional and auto-detected.
